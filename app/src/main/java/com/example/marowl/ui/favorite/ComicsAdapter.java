...
public class ComicsAdapter extends RecyclerView.Adapter<ComicsAdapter.myviewholder> {
    ...
    public ComicsAdapter(Context mContext,List<ComicsModel> data){
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        ...
        holder.comicView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("pdf_url",temp.getPdf_url());
    ...
    public void filterList(List<ComicsModel> filteredList) {
    data=filteredList;
